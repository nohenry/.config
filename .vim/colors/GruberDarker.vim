...
" {{{ Colors
  ...
  let s:gruberNiagara=['#99a5c5', '147']
  " let s:gruberQuartz=['#95a99f', '108']
  let s:gruberQuartz=['#99a8a0', '108']
  " let s:gruberGreen=['#73c936', '70']
  let s:gruberGreen=['#88c74f', '70']
  " let s:gruberMain=['#ffdd33', '220']
  let s:gruberMain=['#f9de59', '220']
...
call <sid>hi('HighlightedyankRegion','',          s:gruberBG2,   '',        '')
...
call <sid>hi('Conditional',   s:gruberMain,       '',            s:bold,          '')
call <sid>hi('Constant',      s:gruberFG,     '',            '',          '')
call <sid>hi('Define',        s:gruberMain,       '',            s:bold,          '')
call <sid>hi('Delimiter',     s:gruberFG,         '',            '',          '')
call <sid>hi('Float',         s:gruberQuartz,     '',            '',          '')
call <sid>hi('Function',      s:gruberFG,    '',            '',          '')
call <sid>hi('odinFunctionDecl',      s:gruberNiagara,    '',            '',          '')
call <sid>hi('Identifier',    s:gruberNiagara,    '',            '',          '')
call <sid>hi('Include',       s:gruberMain,       '',            s:bold,          '')
call <sid>hi('Keyword',       s:gruberMain,       '',            s:bold,          '')
