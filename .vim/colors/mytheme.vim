...
if !exists('g:mytheme_bold')
  let g:mytheme_bold=1
endif
if !exists('g:mytheme_italic')
  if has('gui_running') || $TERM_ITALICS == 'true'
    let g:mytheme_italic=1
  else
    let g:mytheme_italic=0
  endif
endif
if !exists('g:mytheme_undercurl')
  let g:mytheme_undercurl=1
endif
if !exists('g:mytheme_underline')
  let g:mytheme_underline=1
endif
if !exists('g:mytheme_inverse')
  let g:mytheme_inverse=1
endif

if !exists('g:mytheme_guisp_fallback') || index(['fg', 'bg'], g:mytheme_guisp_fallback) == -1
  let g:mytheme_guisp_fallback='NONE'
endif

if !exists('g:mytheme_improved_strings')
  let g:mytheme_improved_strings=0
endif

if !exists('g:mytheme_improved_warnings')
  let g:mytheme_improved_warnings=0
endif

if !exists('g:mytheme_termcolors')
  let g:mytheme_termcolors=256
endif

if !exists('g:mytheme_invert_indent_guides')
  let g:mytheme_invert_indent_guides=0
endif

if exists('g:mytheme_contrast')
  echo 'g:mytheme_contrast is deprecated; use g:mytheme_contrast_light and g:mytheme_contrast_dark instead'
endif

if !exists('g:mytheme_contrast_dark')
  let g:mytheme_contrast_dark='medium'
endif

if !exists('g:mytheme_contrast_light')
  let g:mytheme_contrast_light='medium'
endif
...
let s:italic = 'italic,'
if g:mytheme_italic == 0
  let s:italic = ''
endif

let s:underline = 'underline,'
if g:mytheme_underline == 0
  let s:underline = ''
endif

let s:undercurl = 'undercurl,'
if g:mytheme_undercurl == 0
  let s:undercurl = ''
endif

let s:inverse = 'inverse,'
if g:mytheme_inverse == 0
  let s:inverse = ''
endif
...
if s:is_dark
  ...
  if g:mytheme_contrast_dark == 'soft'
    let s:bg0  = s:gb.dark0_soft
  elseif g:mytheme_contrast_dark == 'hard'
  ...
  if g:mytheme_contrast_light == 'soft'
    let s:bg0  = s:gb.light0_soft
  elseif g:mytheme_contrast_light == 'hard'
...
if exists('g:mytheme_hls_cursor')
  let s:hls_cursor = get(s:gb, g:mytheme_hls_cursor)
endif

let s:number_column = s:none
if exists('g:mytheme_number_column')
  let s:number_column = get(s:gb, g:mytheme_number_column)
endif
...
if exists('g:gitgutter_override_sign_column_highlight') &&
  ...
  if exists('g:mytheme_sign_column')
    let s:sign_column = get(s:gb, g:mytheme_sign_column)
  endif
endif

let s:color_column = s:bg1
if exists('g:mytheme_color_column')
  let s:color_column = get(s:gb, g:mytheme_color_column)
endif

let s:vert_split = s:bg0
if exists('g:mytheme_vert_split')
  let s:vert_split = get(s:gb, g:mytheme_vert_split)
endif

let s:invert_signs = ''
if exists('g:mytheme_invert_signs')
  if g:mytheme_invert_signs == 1
    let s:invert_signs = s:inverse
  endif
endif

let s:invert_selection = s:inverse
if exists('g:mytheme_invert_selection')
  if g:mytheme_invert_selection == 0
    let s:invert_selection = ''
  endif
endif

let s:invert_tabline = ''
if exists('g:mytheme_invert_tabline')
  if g:mytheme_invert_tabline == 1
    let s:invert_tabline = s:inverse
  endif
endif

let s:italicize_comments = s:italic
if exists('g:mytheme_italicize_comments')
  if g:mytheme_italicize_comments == 0
    let s:italicize_comments = ''
  endif
endif

let s:italicize_strings = ''
if exists('g:mytheme_italicize_strings')
  if g:mytheme_italicize_strings == 1
...
function! s:HL(group, fg, ...)
  ...
  " special fallback
  if a:0 >= 3
    if g:mytheme_guisp_fallback != 'NONE'
      let fg = a:3
    endif

    " bg fallback mode should invert higlighting
    if g:mytheme_guisp_fallback == 'bg'
      let emstr .= 'inverse,'
    endif
  endif
...
call s:HL('GruvboxRed', s:red, s:none, s:bold)
...
if g:mytheme_improved_strings == 0
  hi! link Special GruvboxFg1
else
...
if has("spell")
  ...
  if g:mytheme_improved_warnings == 0
...
if g:indent_guides_auto_colors == 0
  if g:mytheme_invert_indent_guides == 0
